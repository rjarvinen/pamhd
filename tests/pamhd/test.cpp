...
// returns a reference to given simulation cell's magnetic field data
const auto Mag
...
const auto Cell_t
	= [](Cell& cell_data)->typename pamhd::mhd::Cell_Type_Field::data_type&{
		return cell_data[pamhd::mhd::Cell_Type_Field()];
	};
